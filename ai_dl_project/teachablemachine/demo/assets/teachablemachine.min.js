...
var tm = function(t) {
				...
				if(null !== t) {
					if(p++, 1 === t.nodeType) {
						...
						if(t.data === r) {
							...
							null !== t.previousSibling && p !== l || (p++, e.insertBefore(u(), t)), l = p, this.parts.push({
								type: "node",
								index: p
							}), null === t.nextSibling ? t.data = "" : (n.push(t), p--), d++
						} else {
							let e = -1;
	...
	class d {
		...
		__commitTemplateResult(t) {
			...
			if(this.value instanceof s.a && this.value.template === e) this.value.update(t.values);
			else {
	...
	const s = new WeakMap,
		a = (t, e, n) => {
			...
			void 0 === a && (Object(r.b)(e, e.firstChild), s.set(e, a = new o.e(Object.assign({
				templateFactory: i.b
			}, n))), a.appendInto(e)), a.setValue(t), a.commit()
		}
}, function(t, e, n) {
	"use strict";
	n.d(e, "b", (function() {
	...
	class s extends o.LitElement {
		...
		click(t) {
			t && t.stopPropagation(), this.dispatchEvent(new CustomEvent("click", {
				bubbles: !0,
				composed: !0
			}))
		}
	...
	r([o.property({
		type: String
	})], s.prototype, "label", void 0), r([o.property({
		type: String
	})], s.prototype, "iconType", void 0), r([o.property({
		type: Boolean
	})], s.prototype, "disabled", void 0), r([i.default], s.prototype, "click", null), e.ButtonElement = s, customElements.define("tm-button", s)
}, function(t, e) {
	...
	d.defaultCrop = {
		...
		type: Boolean,
		reflect: !0
	})], d.prototype, "edit", void 0), o([i.property({
		type: Number,
		reflect: !0
	})], d.prototype, "cropLeft", void 0), o([i.property({
		type: Number
	})], d.prototype, "cropTop", void 0), o([i.property({
		type: Number
	})], d.prototype, "cropWidth", void 0), o([i.property({
		type: Number
	})], d.prototype, "cropHeight", void 0), o([i.property({
		type: Number
	})], d.prototype, "minCropWidth", void 0), o([i.property({
		type: Number
	})], d.prototype, "minCropHeight", void 0), o([i.property({
		type: Number
	})], d.prototype, "scaledVideoWidth", void 0), o([i.property({
		type: Number
	})], d.prototype, "scaledVideoHeight", void 0), o([i.property({
		type: Number
	})], d.prototype, "aspect", void 0), o([i.property({
		type: Boolean,
		reflect: !0
		...
		var s, a = n(9),
			...
			m = function() {
				...
				return t.prototype.ready = function() {
					...
					var u, h = [],
						p = this.isTapeOn(),
						d = null != this.state.activeScope ? this.state.activeScope.name : "",
						f = function(t) {
					...
					if(this.state.numTensors++, "string" === t.dtype && this.state.numStringTensors++, 0 === n) {
						...
						var r = 0;
						"complex64" !== t.dtype && "string" !== t.dtype && (r = t.size * d.bytesPerElement(t.dtype)), this.state.tensorInfo.set(t.dataId, {
	...
	let h = r = class extends l.AbstractSampleInputElement {
		...
		__saveSettings() {
			r.lastWebcamThrottle = this.webcamThrottle, r.lastHoldToRecord = this.holdToRecord, r.lastRecordDelay = this.recordDelay, r.lastRecordDuration = this.recordDuration, u.default.setWebcamSetting({
	...
	h.middleSlotName = "middle", h.lastWebcamThrottle = null !== u.default.getWebcamSetting("webcamThrottle") ? Number(u.default.getWebcamSetting("webcamThrottle")) : 24, h.lastHoldToRecord = null === u.default.getWebcamSetting("holdToRecord") || u.default.getWebcamSetting("holdToRecord"), h.lastRecordDelay = null !== u.default.getWebcamSetting("recordDelay") ? Number(u.default.getWebcamSetting("recordDelay")) : 2e3, h.lastRecordDuration = null !== u.default.getWebcamSetting("recordDuration") ? Number(u.default.getWebcamSetting("recordDuration")) : 6e3, o([s.property({
		type: String
	})], h.prototype, "buttonLabel", void 0), o([s.property({
		type: String
	})], h.prototype, "buttonSVG", void 0), o([s.property({
		type: Number
	})], h.prototype, "webcamThrottle", void 0), o([s.property({
		type: Boolean
	})], h.prototype, "holdToRecord", void 0), o([s.property({
		type: Number
	})], h.prototype, "recordDelay", void 0), o([s.property({
		type: Number
	})], h.prototype, "recordDuration", void 0), o([s.property({
		type: Boolean,
		reflect: !0
	})], h.prototype, "autoPlay", void 0), o([s.property({
		type: Boolean
	})], h.prototype, "autoRecord", void 0), o([s.property({
		type: Boolean,
		reflect: !0
	})], h.prototype, "settings", void 0), o([s.property({
		type: Boolean,
		reflect: !0
	})], h.prototype, "showRecord", void 0), o([a.default], h.prototype, "__handleWebcamFrame", null), o([a.default], h.prototype, "__handleHoldToRecordStart", null), h = r = o([s.customElement("tm-webcam-sample-input")], h), e.WebcamSampleInput = h
}, function(t, e, n) {
	"use strict";
	var r, o = this && this.__decorate || function(t, e, n, r) {
			var o, i = arguments.length,
	...
	let d = r = class extends l.AbstractUserMediaElement {
		...
		play(t) {
			return t && (this.__promiseGetWebcam = null), void 0 === (t = t || {}).deviceId && "string" == typeof this.deviceId && (t.deviceId = this.deviceId), !(t.width > 0) && this.deviceWidth > 0 && (t.width = this.deviceWidth), !(t.height > 0) && this.deviceHeight > 0 && (t.height = this.deviceHeight), this.__promiseGetWebcam && this.__promiseHasResized || (this._isInitialized = !1, this.__promiseHasResized = new Promise(t => {
				...
				console.log(t), this._isOk = !1, this.dispatchEvent(new CustomEvent("webcamReject", {
					bubbles: !0
				}))
			}).then(t => {
				...
				if(this.__curentMediaStreamTrack = e, this._lastMediaTrackConstraints = n, this.deviceId = n && "string" == typeof n.deviceId ? n.deviceId : "default", r) return r.play().then(() => (this._isOk = !0, r.videoWidth === this.deviceWidth && r.videoHeight === this.deviceHeight || (this.deviceWidth = r.videoWidth, this.deviceHeight = r.videoHeight, this.__skipNextUpdatingConstraints = !0), this.dispatchEvent(new CustomEvent("webcamAccept", {
					bubbles: !0
				})), r))
		...
		update(t) {
			if(t.has("deviceWidth") || t.has("deviceHeight"))
				if(this.__skipNextUpdatingConstraints) this.__skipNextUpdatingConstraints = !1;
				else {
	...
	d.flip = !0, o([s.property({
		type: Boolean,
		reflect: !0
	})], d.prototype, "stats", void 0), o([s.property({
		type: Number
	})], d.prototype, "throttle", void 0), o([s.property({
		type: Number,
		reflect: !0
	})], d.prototype, "width", void 0), o([s.property({
		type: Number,
		reflect: !0
	})], d.prototype, "height", void 0), o([s.property({
		type: Number,
		reflect: !0
	})], d.prototype, "deviceWidth", void 0), o([s.property({
		type: Number,
		reflect: !0
	})], d.prototype, "deviceHeight", void 0), o([s.property({
		type: String
	})], d.prototype, "deviceId", void 0), o([a.default], d.prototype, "_handleLoopUpdate", null), d = r = o([s.customElement("tm-webcam")], d), e.WebcamElement = d
}, function(t, e, n) {
	"use strict";
	var r = this && this.__decorate || function(t, e, n, r) {
		var o, i = arguments.length,
	...
	let c = class extends i.LitElement {
		...
		_handleDelayUpdate(t, e) {
			this._updateFill(e / this.delay), this._updateLabel(), this.dispatchEvent(new CustomEvent("delayupdate", {
				bubbles: !0
		...
		_handleDelayComplete() {
			this.dispatchEvent(new CustomEvent("delaycomplete", {
				bubbles: !0
			})), this._delayLoop.stop(), this._loop.start()
		}
		_handleLoopStart() {
			this.__isActive = !0, this.dispatchEvent(new CustomEvent("start", {
				bubbles: !0
			}))
		}
		_handleLoopStop() {
			this.__isActive = !1, this.dispatchEvent(new CustomEvent("stop", {
				bubbles: !0
			}))
		}
		_handleLoopComplete() {
		...
		_handleLoopUpdate(t, e) {
			this._updateFill(e / this.duration), this._updateLabel(), this.dispatchEvent(new CustomEvent("update", {
				bubbles: !0
		...
		cancel() {
			return !(!this.cancelable || !this._delayLoop.isRunning() && !this._loop.isRunning()) && (this._delayLoop.stop(), this._delayLoop.reset(), this._loop.stop(), this._loop.reset(), this._updateLabel(), this.dispatchEvent(new CustomEvent("cancel", {
				bubbles: !0
			})), !0)
		}
		start() {
	...
	r([i.property({
		type: Number
	})], c.prototype, "delayOnComplete", void 0), r([i.property({
		type: Boolean
	})], c.prototype, "cancelable", void 0), r([i.property({
		type: Number
	})], c.prototype, "delay", void 0), r([i.property({
		type: Number
	})], c.prototype, "duration", void 0), r([i.property({
		type: Number
	})], c.prototype, "fps", void 0), r([i.property({
		type: Boolean,
		reflect: !0
	})], c.prototype, "hideProgress", void 0), r([i.property({
		type: String
	...
	r([o.property({
		type: Number
	})], s.prototype, "value", void 0), r([o.property({
		type: Number
	})], s.prototype, "min", void 0), r([o.property({
		type: Number
	})], s.prototype, "max", void 0), r([o.property({
		type: String
	})], s.prototype, "label", void 0), r([o.property({
		type: Boolean,
		reflect: !0
	})], s.prototype, "disabled", void 0), r([i.default], s.prototype, "click", null), s = r([o.customElement("tm-progress-button")], s), e.ProgressButtonElement = s
}, function(t, e, n) {
	"use strict";
	var r, o = this && this.__extends || (r = function(t, e) {
			return(r = Object.setPrototypeOf || {
	...
	class h extends o.LitElement {
		...
		_handleLoopPlay() {
			return this.dispatchEvent(new CustomEvent("play")), this._loop && this._loop.stop(), this._loop = new i.Animitter({
				fps: this.throttledFrameRate
			}), this._loop.on("update", this._handleLoopUpdate), this._loop.start(), this
		}
		update(t) {
	...
	h.__instances = [], r([o.property({
		type: Boolean
	})], h.prototype, "autoplay", void 0), r([o.property({
		type: Number
	})], h.prototype, "throttle", void 0), r([s.default], h.prototype, "_handleLoopPlay", null), e.AbstractUserMediaElement = h
}, function(t, e, n) {
	"use strict";
	Object.defineProperty(e, "__esModule", {
		value: !0
	...
	let i = class extends o.LitElement {
		...
		render() {
			const {
				...
				max: n,
				label: r
			} = this, [i, s, a] = t.split(" "), c = e / n, l = Math.round(100 * c);
			return o.html `
            <style>
                :host {
                    height: 29px;
	...
	r([o.property({
		type: String
	})], i.prototype, "colors", void 0), r([o.property({
		type: Number
	})], i.prototype, "value", void 0), r([o.property({
		type: Number
	})], i.prototype, "max", void 0), r([o.property({
		type: String
	})], i.prototype, "label", void 0), r([o.property({
		type: String,
		reflect: !0
	})], i.prototype, "display", void 0), i = r([o.customElement("tm-bar-graph")], i), e.BarGraphElement = i
}, function(t, e, n) {
	"use strict";
	Object.defineProperty(e, "__esModule", {
		value: !0
			...
			return void 0 === n && (n = !1), r(this, void 0, void 0, (function() {
				...
				return o(this, (function(o) {
					switch(o.label) {
						...
						case 1:
							for(u = o.sent(), h = [], p = 0; p < u.length; p++) h.push({
		...
		return r(this, void 0, void 0, (function() {
			...
			return o(this, (function(o) {
				switch(o.label) {
					...
					case 1:
						return a = o.sent(), t && 1 === t.version ? (c = a.getLayer(s), l = i.model({
							inputs: a.inputs,
							outputs: c.output
						}), (u = i.sequential()).add(l), u.add(i.layers.flatten()), [2, u]) : (c = a.getLayer(s), l = i.model({
							inputs: a.inputs,
							outputs: c.output
						}), (u = i.sequential()).add(l), u.add(i.layers.globalAveragePooling2d({})), [2, u])
				}
			}))
		}))
	}, e.load = function(t, e) {
	...
	class c extends i.HTTPRequest {
		...
		save(t) {
			return r(this, void 0, void 0, (function*() {
				...
				}), "model.weights.bin"), e.body.append("metadata.json", new Blob([JSON.stringify(this.metadata)], {
					type: "application/json"
				}), "metadata.json");
	...
	e.MetadataBrowserHTTPRequest = c, e.metadataBrowserHTTPRequest = function(t, e, n) {
		const r = {};
		return e && (r["x-token"] = n, r["x-model-name"] = e), new c(t, a.config.PUBLISH_URL, {
			requestInit: {
				method: "POST",
				headers: r
			}
	...
	Object.defineProperty(e, "__esModule", {
		value: !0
	}), n(35), n(16), n(22), n(29), n(26), n(28), n(50), n(27), n(36), r(n(16)), r(n(22)), r(n(29)), r(n(27)), r(n(26)), r(n(28)), r(n(50));
	var o = n(109);
	e.version = o.version
}, function(t, e, n) {
	"use strict";
	...
	r([o.property({
		type: Boolean
	})], i.prototype, "disabled", void 0), r([o.property({
		type: Boolean
	})], i.prototype, "hideLabel", void 0), r([o.property({
		type: Boolean
	})], i.prototype, "checked", void 0), r([o.property({
		type: String
	})], i.prototype, "label", void 0), i = r([o.customElement("tm-toggle")], i), e.ToggleElement = i
}, function(t, e, n) {
	"use strict";
	...
	class u {
		...
		createInferenceCamera(t = {}) {
			...
			n.width = e.size, n.height = e.size, e.autoPlay ? n.play({
				deviceId: e.deviceId
	...
	u.defaultInferenceWebcamSettings = {
		autoPlay: !0,
		size: 290
	}, r([l.default], u.prototype, "handleWizardOpen", null), r([l.default], u.prototype, "handleWizardClose", null), r([l.default], u.prototype, "open", null), e.Wizard = u
}, function(t, e, n) {
	"use strict";
	var r = this && this.__decorate || function(t, e, n, r) {
			var o, i = arguments.length,
	...
	let d = class extends i.LitElement {
		...
		addSample(t, e) {
			return o(this, void 0, void 0, (function*() {
				...
				const n = () => o(this, void 0, void 0, (function*() {
					yield this.model.addExample(t, e), this.__modelHasBeenTrained = !1, this.dispatchEvent(new CustomEvent("sampleadd", {
						detail: {
							index: t,
							name: this.classes[t],
							sample: e
		...
		loadModel(t = {}) {
			...
			return this.samples = [], c.createTeachable({
				tfjsVersion: "0.0.0",
				tmVersion: "0.0.0"
			}, e).then(t => (this.model = t, this.model.setLabels(this.classes.map(t => t.name)), this.model.warm(), Promise.resolve()))
		}
		train() {
			return o(this, void 0, void 0, (function*() {
		...
		renderRunCard() {
            ...
            <div id="right-content">
                <h2 class="top-drop">${this.stepIndex}. 测试!</h2>
                <p>
                    现在试着进行模型训练，你应该会看到识别程度条相应地移动。如果它不工作，点击“返回”来调整你的示例，或者只是点击“完成”。
                </p>
            </div>
        `
		}
		...
		getPart() {
			...
			return t.push(this.renderTrainCard, this.renderRunCard), t[this.stepIndex]()
		}
		render() {
			return i.html `
            <style>
	...
	r([i.property({
		type: Boolean,
		reflect: !0
	})], d.prototype, "open", void 0), r([i.property({
		type: Array
	})], d.prototype, "classes", void 0), r([i.property({
		type: Object
	})], d.prototype, "inputSettings", void 0), r([i.property({
		type: Object
	})], d.prototype, "training", void 0), r([i.property({
		type: Object
	})], d.prototype, "introduction", void 0), r([a.default], d.prototype, "renderIntroCard", null), r([a.default], d.prototype, "renderClassifierCard", null), r([a.default], d.prototype, "renderTrainCard", null), r([a.default], d.prototype, "renderRunCard", null), r([a.default], d.prototype, "renderPublishCard", null), d = r([i.customElement("ta-wizard")], d), e.WizardElement = d
}, function(t, e, n) {
	"use strict";
	var r = this && this.__decorate || function(t, e, n, r) {
		var o, i = arguments.length,
	...
	r([o.property({
		type: Number
	})], s.prototype, "steps", void 0), r([o.property({
		type: Number
	})], s.prototype, "value", void 0), s = r([o.customElement("progress-bars")], s), e.ProgressBarsElement = s
}, function(t, e, n) {
	"use strict";
	Object.defineProperty(e, "__esModule", {
		value: !0
	...
	r([o.property({
		type: String
	})], a.prototype, "color", void 0), r([o.property({
		type: Array
	})], a.prototype, "samples", void 0), r([o.property({
		type: String
	})], a.prototype, "label", void 0), r([o.property({
		type: Boolean,
		reflect: !0
	})], a.prototype, "play", void 0), r([o.property({
		type: Number
	})], a.prototype, "fps", void 0), r([o.property({
		type: Boolean,
		reflect: !0
	})], a.prototype, "showClassName", void 0), r([s.default], a.prototype, "handleLoopUpdate", null), a = r([o.customElement("tm-class-samples-animation")], a), e.ClassSamplesAnimationElement = a
}, function(t, e, n) {
	"use strict";
	...
	Object.create && (i.prototype = Object.create(null), (new i).__proto__ || (o = !1)), l.prototype.eventNames = function() {
		...
		if(u.fn) {
			...
			for(l = 0; l < d; l++) switch(u[l].once && this.removeListener(t, u[l].fn, void 0, !0), h) {
				...
				default:
					if(!c)
						for(p = 1, c = new Array(h - 1); p < h; p++) c[p - 1] = arguments[p];
		...
		if(s.fn) s.fn !== e || r && !s.once || n && s.context !== n || c(this, i);
		else {
	...
	class l extends s.LitElement {
		...
		clearSamples() {
			this._samples = [], this._displaySamples = [], this._sampleUIDs = [], this.dispatchEvent(new CustomEvent("clear", {
				bubbles: !0,
				composed: !0
			}))
		}
		...
		__dispatchSample() {
			this._statsElement && this._statsElement.now(), this.dispatchEvent(new CustomEvent("sample", {
				bubbles: !0,
				composed: !1
			}))
		}
	...
	r([s.property({
		type: Boolean,
		reflect: !0
	})], l.prototype, "stats", void 0), r([s.property({
		type: String
	})], l.prototype, "label", void 0), r([s.property({
		type: String
	})], l.prototype, "buttonLabel", void 0), r([s.property({
		type: String
	})], l.prototype, "buttonSVG", void 0), r([s.property({
		type: Boolean,
		reflect: !0
	})], l.prototype, "open", void 0), r([s.property({
		type: Boolean,
		reflect: !0
	})], l.prototype, "disabled", void 0), r([s.property({
		type: Number
	})], l.prototype, "sampleSize", void 0), r([s.property({
		type: Boolean
	})], l.prototype, "runSample", void 0), r([s.property({
		type: Boolean
	})], l.prototype, "skipDisplaySample", void 0), r([s.property({
		type: Number
	})], l.prototype, "maxSamples", void 0), r([s.property({
		type: Boolean
	})], l.prototype, "samplesArePlayable", void 0), e.AbstractSampleInputElement = l
}, function(t, e, n) {
	var r, o = n(66),
		i = n(68),
	...
	r([i.property({
		type: String
	})], c.prototype, "value", void 0), r([i.property({
		type: String
	})], c.prototype, "kind", void 0), r([i.property({
		type: Boolean
	})], c.prototype, "hideWhenEmpty", void 0), e.MediaDeviceSelectElement = c, customElements.define("tm-media-device-select", c)
}, function(t, e, n) {
	"use strict";
	Object.defineProperty(e, "__esModule", {
		value: !0
	...
	var d = function(t) {
		...
		return o(e, t), Object.defineProperty(e.prototype, "asSequentialModel", {
			...
			var e = [],
				n = [],
				r = function(t) {
					var r, i, s, a = (r = t, i = o.numClasses, (s = new Array(i).fill(0))[r] = 1, s),
					...
					switch(s.label) {
						case 0:
							if(n = e.onTrainEnd || function() {}, e.onTrainEnd = function(t) {
								...
								})), o = this.truncatedModel.outputs[0].shape.slice(1), i = a.util.sizeFromShape(o), l = this.seed ? a.initializers.varianceScaling({
									seed: 3.14
								}) : a.initializers.varianceScaling({}), this.trainingModel = a.sequential({
								...
								}), u = a.train.adam(t.learningRate), this.trainingModel.compile({
									optimizer: u,
									loss: "categoricalCrossentropy",
									metrics: ["accuracy"]
								}), !(t.batchSize > 0)) throw new Error("Batch size is 0 or NaN. Please choose a non-zero fraction");
							return h = this.trainDataset.batch(t.batchSize), p = this.validationDataset.batch(t.batchSize), [4, this.trainingModel.fitDataset(h, {
								epochs: t.epochs,
								validationData: p,
								callbacks: e
							})];
					...
					switch(x.label) {
						...
						case 7:
							if(v = a.concat(p), b = a.concat(h), 1 !== r)
								for(w = 0; w < h.length; w++) h[w].dispose(), p[w].dispose();
							return [2, {
								reference: v,
								predictions: b
							}]
	...
	(function(t) {
		...
		function p(t, e, n, r, o, i) {
			...
			if((c = Object.getOwnPropertyDescriptor(e, o) || {
					value: e[o]
				}).get ? a = c.set ? t.stylize("[Getter/Setter]", "special") : t.stylize("[Getter]", "special") : c.set && (a = t.stylize("[Setter]", "special")), A(r, o) || (s = "[" + o + "]"), a || (t.seen.indexOf(c.value) < 0 ? (a = y(n) ? u(t, c.value, null) : u(t, c.value, n - 1)).indexOf("\n") > -1 && (a = i ? a.split("\n").map((function(t) {
					return "  " + t
				})).join("\n").substr(2) : "\n" + a.split("\n").map((function(t) {
					return "   " + t
		...
		e.debuglog = function(n) {
			if(v(i) && (i = t.env.NODE_DEBUG || ""), n = n.toUpperCase(), !s[n])
			...
			date: "magenta",
			regexp: "red"
		}, e.isArray = d, e.isBoolean = f, e.isNull = y, e.isNullOrUndefined = function(t) {
			return null == t
	...
	e.tensorToString = function(t, e, n, a) {
		var c = r.computeStrides(e),
			l = function(t, e, n, i) {
				...
				if(u > 1)
					for(var p = 0; p < a / c; p++)
						for(var d = p * c, f = 0; f < c; f++) l[f] = Math.max(l[f], o(h[d + f], 0, n).length);
				return l
			}(t, e, n, c),
			u = e.length,
			...
			return new Promise((function(t, r) {
				...
				o.onupgradeneeded = function() {
					...
					if(null == e) {
						...
						var l, u = s.getModelArtifactsInfoForJSON(e),
	...
	e.purgeLocalStorageArtifacts = function() {
		...
		for(var t = window.localStorage, e = [], n = 0; n < t.length; ++n) {
			...
			if(r.startsWith(o) && r.length > o.length) {
				t.removeItem(r);
				var s = g(r); - 1 === e.indexOf(s) && e.push(s)
			}
		}
		return e
	};
		...
		return t.prototype.save = function(t) {
			return r(this, void 0, void 0, (function() {
				...
				return o(this, (function(o) {
					...
					try {
						return this.LS.setItem(this.keys.info, JSON.stringify(r)), this.LS.setItem(this.keys.topology, e), this.LS.setItem(this.keys.weightSpecs, n), this.LS.setItem(this.keys.weightData, a.arrayBufferToBase64String(t.weightData)), this.LS.setItem(this.keys.modelMetadata, JSON.stringify({
							format: t.format,
							generatedBy: t.generatedBy,
							convertedBy: t.convertedBy
						})), [2, {
					...
					switch(o.label) {
						...
						case 1:
							return n = [{
								...
								type: "application/json"
							})), (a = null == this.jsonAnchor ? document.createElement("a") : this.jsonAnchor).download = this.modelTopologyFileName, a.href = i, [4, c((function() {
	...
	e.fromMemory = function(t, e, n, r) {
		if(1 === arguments.length) {
			...
			return o ? new i(t) : (console.warn("Please call tf.io.fromMemory() with only one argument. The argument should be of type ModelArtifacts. The multi-argument signature of tf.io.fromMemory() has been deprecated and will be removed in a future release."), new i({
				modelTopology: t
			}))
		}
		return console.warn("Please call tf.io.fromMemory() with only one argument. The argument should be of type ModelArtifacts. The multi-argument signature of tf.io.fromMemory() has been deprecated and will be removed in a future release."), new i({
			modelTopology: t,
			weightSpecs: e,
			weightData: n,
			trainingConfig: r
	...
	r([o.property({
		type: String
	})], i.prototype, "label", void 0), i = r([o.customElement("teachable-button")], i), e.TeachableButtonElement = i
}, function(t, e, n) {
	"use strict";
	var r = this && this.__awaiter || function(t, e, n, r) {
		return new(n || (n = Promise))((function(o, i) {
		...
		load() {
			return r(this, void 0, void 0, (function*() {
				this.teachable = yield o.createTeachable({}, {
					alpha: .35,
					version: 2
				}), this.teachable.setLabels(this.labels), this.teachable.warm()
			}))
		}
