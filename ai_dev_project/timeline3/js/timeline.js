var TL = function(t) {
	...
	t.exports = function() {
		...
		return function t() {
			...
			var ct = z,
				...
				Zt = function(t) {
					Wt && Wt === t || (t && "object" === (void 0 === t ? "undefined" : B(t)) || (t = {}), gt = "ALLOWED_TAGS" in t ? M({}, t.ALLOWED_TAGS) : vt, yt = "ALLOWED_ATTR" in t ? M({}, t.ALLOWED_ATTR) : bt, $t = "ADD_URI_SAFE_ATTR" in t ? M(L(Bt), t.ADD_URI_SAFE_ATTR) : Bt, Ht = "ADD_DATA_URI_TAGS" in t ? M(L(Ft), t.ADD_DATA_URI_TAGS) : Ft, wt = "FORBID_TAGS" in t ? M({}, t.FORBID_TAGS) : {}, xt = "FORBID_ATTR" in t ? M({}, t.FORBID_ATTR) : {}, Pt = "USE_PROFILES" in t && t.USE_PROFILES, kt = !1 !== t.ALLOW_ARIA_ATTR, Tt = !1 !== t.ALLOW_DATA_ATTR, Mt = t.ALLOW_UNKNOWN_PROTOCOLS || !1, Lt = t.SAFE_FOR_JQUERY || !1, Et = t.SAFE_FOR_TEMPLATES || !1, St = t.WHOLE_DOCUMENT || !1, jt = t.RETURN_DOM || !1, Ct = t.RETURN_DOM_FRAGMENT || !1, Nt = t.RETURN_DOM_IMPORT || !1, It = t.RETURN_TRUSTED_TYPE || !1, At = t.FORCE_BODY || !1, Ot = !1 !== t.SANITIZE_DOM, zt = !1 !== t.KEEP_CONTENT, Rt = t.IN_PLACE || !1, mt = t.ALLOWED_URI_REGEXP || mt, Et && (Tt = !1), Ct && (jt = !0), Pt && (gt = M({}, [].concat(W(j))), yt = [], !0 === Pt.html && (M(gt, E), M(yt, C)), !0 === Pt.svg && (M(gt, S), M(yt, N), M(yt, O)), !0 === Pt.svgFilters && (M(gt, D), M(yt, N), M(yt, O)), !0 === Pt.mathMl && (M(gt, A), M(yt, I), M(yt, O))), t.ADD_TAGS && (gt === vt && (gt = L(gt)), M(gt, t.ADD_TAGS)), t.ADD_ATTR && (yt === bt && (yt = L(yt)), M(yt, t.ADD_ATTR)), t.ADD_URI_SAFE_ATTR && M($t, t.ADD_URI_SAFE_ATTR), zt && (gt["#text"] = !0), St && M(gt, ["html", "head", "body"]), gt.table && (M(gt, ["tbody"]), delete wt.tbody), r && r(t), Wt = t)
				},
				Gt = function(t) {
					f(i.removed, {
						element: t
			...
			var Jt = function(t) {
				...
				te = function(t) {
					...
					return "noscript" === n && b(/<\/noscript/i, t.innerHTML) || "noembed" === n && b(/<\/noembed/i, t.innerHTML) ? (Gt(t), !0) : (!Lt || t.firstElementChild || t.content && t.content.firstElementChild || !b(/</g, t.textContent) || (f(i.removed, {
						element: t.cloneNode()
	...
	(function(t, n) {
		...
		(function() {
			var a = "Expected a function",
				...
				Ot = RegExp([Mt + "?" + yt + "+(?:['’](?:d|ll|m|re|s|t|ve))?(?=" + [_t, Mt, "$"].join("|") + ")", Et + "+(?:['’](?:D|LL|M|RE|S|T|VE))?(?=" + [_t, Mt + Lt, "$"].join("|") + ")", Mt + "?" + Lt + "+(?:['’](?:d|ll|m|re|s|t|ve))?", Mt + "+(?:['’](?:D|LL|M|RE|S|T|VE))?", "\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])", "\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])", gt, At].join("|"), "g"),
				zt = RegExp("[\\u200d\\ud800-\\udfff" + dt + "\\ufe0e\\ufe0f]"),
				...
				qt = -1,
				Ht = {};
			Ht[M] = Ht[L] = Ht[E] = Ht[S] = Ht[D] = Ht[A] = Ht["[object Uint8ClampedArray]"] = Ht[j] = Ht[C] = !0, Ht[l] = Ht[h] = Ht[k] = Ht[c] = Ht[T] = Ht[u] = Ht[d] = Ht[f] = Ht[_] = Ht[m] = Ht[g] = Ht[v] = Ht[y] = Ht[b] = Ht[x] = !1;
			var Ft = {};
			Ft[l] = Ft[h] = Ft[k] = Ft[T] = Ft[c] = Ft[u] = Ft[M] = Ft[L] = Ft[E] = Ft[S] = Ft[D] = Ft[_] = Ft[m] = Ft[g] = Ft[v] = Ft[y] = Ft[b] = Ft[w] = Ft[A] = Ft["[object Uint8ClampedArray]"] = Ft[j] = Ft[C] = !0, Ft[d] = Ft[f] = Ft[x] = !1;
			var $t = {
					"\\": "\\",
					"'": "'",
					"\n": "n",
			...
			var Ye = function t(e) {
				...
				function bn(t, e, i, n, r) {
					return t === e || (null == t || null == e || !Wo(t) && !Wo(e) ? t != t && e != e : function(t, e, i, n, r, a) {
						...
						if(L && !x) return a || (a = new zi), o || Ko(t) ? Br(t, e, i, n, r, a) : function(t, e, i, n, r, a, o) {
							switch(i) {
								case T:
				...
				function xn(t) {
					return !(!Bo(t) || (e = t, Lt && Lt in e)) && (Ho(t) ? At : ot).test(La(t));
					var e
				}
				...
				var Mo = lr((function(t, e) {
					...
					Lo = Pn((function(t, e) {
						return qr(t, 32, void 0, e, $e(e, Vr(Lo)))
					})),
					Eo = Pn((function(t, e) {
						return qr(t, 64, void 0, e, $e(e, Vr(Eo)))
					})),
					So = Wr((function(t, e) {
				...
				var ls = br((function(t, e) {
						if(ua(e) || Oo(e)) vr(e, bs(e), t);
							...
							for(var i in e) Tt.call(e, i) && $i(t, i, e[i])
					})),
					hs = br((function(t, e) {
						vr(e, ws(e), t)
					})),
				...
				return Ei.after = function(t, e) {
				...
				}, Ei.ary = mo, Ei.assign = ls, Ei.assignIn = hs, Ei.assignInWith = cs, Ei.assignWith = us, Ei.at = ds, Ei.before = go, Ei.bind = vo, Ei.bindAll = $s, Ei.bindKey = yo, Ei.castArray = function() {
				...
				}, Ei.constant = Bs, Ei.countBy = no, Ei.create = function(t, e) {
					var i = Si(t);
					...
					return r.placeholder = t.placeholder, r
				}, Ei.debounce = bo, Ei.defaults = fs, Ei.defaultsDeep = ps, Ei.defer = wo, Ei.delay = xo, Ei.difference = Sa, Ei.differenceBy = Da, Ei.differenceWith = Aa, Ei.drop = function(t, e, i) {
					var n = null == t ? 0 : t.length;
					...
					return qr(t, 512)
				}, Ei.flow = Ws, Ei.flowRight = Us, Ei.fromPairs = function(t) {
				...
				}, Ei.intersection = Oa, Ei.intersectionBy = za, Ei.intersectionWith = Ra, Ei.invert = gs, Ei.invertBy = vs, Ei.invokeMap = ho, Ei.iteratee = Gs, Ei.keyBy = co, Ei.keys = bs, Ei.keysIn = ws, Ei.map = uo, Ei.mapKeys = function(t, e) {
					var i = {};
				...
				}, Ei.pull = qa, Ei.pullAll = Ha, Ei.pullAllBy = function(t, e, i) {
				...
				}, Ei.reverse = $a, Ei.sampleSize = function(t, e, i) {
					...
					return mo(t, 1)
				}, Ei.union = Ba, Ei.unionBy = Wa, Ei.unionWith = Ua, Ei.uniq = function(t) {
				...
				}, Ei.without = Ya, Ei.words = Hs, Ei.wrap = function(t, e) {
					return Lo(or(e), t)
				...
				}, Ei.hasIn = ms, Ei.head = Ia, Ei.identity = Zs, Ei.includes = function(t, e, i, n) {
				...
				}, Ei.invoke = ys, Ei.isArguments = Co, Ei.isArray = No, Ei.isArrayBuffer = Io, Ei.isArrayLike = Oo, Ei.isArrayLikeObject = zo, Ei.isBoolean = function(t) {
				...
				}, Ei.isError = qo, Ei.isFinite = function(t) {
					return "number" == typeof t && ii(t)
				}, Ei.isFunction = Ho, Ei.isInteger = Fo, Ei.isLength = $o, Ei.isMap = Uo, Ei.isMatch = function(t, e) {
					...
					return null === t
				}, Ei.isNumber = Zo, Ei.isObject = Bo, Ei.isObjectLike = Wo, Ei.isPlainObject = Go, Ei.isRegExp = Yo, Ei.isSafeInteger = function(t) {
				...
				}, Ei.lowerCase = Is, Ei.lowerFirst = Os, Ei.lt = Qo, Ei.lte = ts, Ei.max = function(t) {
					...
					var r, a, o = cs({}, e.imports, n.imports, Hr),
						s = bs(o),
						l = je(o, s),
						h = 0,
						c = e.interpolate || ct,
					...
					var e = ++Mt;
					return ss(t) + e
				}, Ei.upperCase = Ps, Ei.upperFirst = qs, Ei.each = oo, Ei.eachRight = so, Ei.first = Ia, Js(Ei, (cl = {}, ln(Ei, (function(t, e) {
					Tt.call(Ei.prototype, e) || (cl[e] = t)
				})), cl), {
					chain: !1
				}), Ei.VERSION = "4.17.19", se(["bind", "bindKey", "curry", "curryRight", "partial", "partialRight"], (function(t) {
					Ei[t].placeholder = Ei
	...
	const P = (q = 0, H = "_tl_id", function(t) {
	...
	let Q = (et = (tt = "123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ").length, {
		encode: function(t) {
	...
	ht.extend = function(t) {
		...
		return t.statics && (I(e, t.statics), delete t.statics), t.includes && (I.apply(null, [n].concat(t.includes)), delete t.includes), t.options && n.options && (t.options = I({}, n.options, t.options)), I(n, t), e.extend = ht.extend, e.include = function(t) {
			I(this.prototype, t)
		}, e
	};
	class ct {
		...
		fire(t, e) {
			...
			for(var i = N({
					type: t,
					target: this
				}, e), n = this._tl_events[t].slice(), r = 0, a = n.length; r < a; r++) n[r].action ? n[r].action.call(n[r].context || this, i) : z(`no action defined for ${t} listener`);
			return this
		}
	}
		...
		function C(t, e) {
			...
			for(u && (n = e.left, r = e.top, delete e.right, delete e.bottom, delete e.left, delete e.top), i = a.length; i--;) {
				...
				for(var E in e) {
					...
					var C, N = g(a[i], E),
						I = L(e[E]) ? e[E](a[i]) : e[E];
					"string" != typeof I || !s.test(I) || s.test(N) ? (d[i][E] = "transform" == E ? x(N) : "string" == typeof I && s.test(I) ? T(N).slice(1) : parseFloat(N), f[i][E] = "transform" == E ? x(I, d[i][E]) : "string" == typeof I && "#" == I.charAt(0) ? T(I).slice(1) : j(I, parseFloat(N)), "string" == typeof I && (C = I.match(h)) && (p[i][E] = C[1])) : delete e[E]
				}
			}
	...
	class pt {
		...
		_onDragEnd(t) {
			this.data.sliding = !1, mt.removeListener(this._el.drag, this.dragevent.move, this._onDragMove, this), mt.removeListener(this._el.drag, this.dragevent.leave, this._onDragEnd, this), this.fire("dragend", this.data), this._momentum()
		}
		_onDragMove(t) {
		...
		_animateMomentum() {
			...
			this.options.enable.y && ((this.options.constraint.top || this.options.constraint.bottom) && (t.y > this.options.constraint.bottom ? t.y = this.options.constraint.bottom : t.y < this.options.constraint.top && (t.y = this.options.constraint.top)), e.top = Math.floor(t.y) + "px"), this.options.enable.x && ((this.options.constraint.left || this.options.constraint.right) && (t.x > this.options.constraint.left ? t.x = this.options.constraint.left : t.x < this.options.constraint.right && (t.x = this.options.constraint.right)), e.left = Math.floor(t.x) + "px"), this.animator = ut(this._el.move, e), this.fire("momentum", this.data)
		}
	}
	$(ct);
	var _t, mt = {
			addListener: function(t, e, i, n) {
				...
				if(!t[a]) {
					...
					if(x && "dblclick" === e && this.addDoubleTapListener) this.addDoubleTapListener(t, o, r);
						...
						o = function(e) {
							if(mt._checkMouse(t, e)) return s(e)
	...
	window.Zepto = gt, void 0 === window.$ && (window.$ = gt),
		function(t) {
			t.zepto.qsa;
			var e = 1,
		...
		function(t) {
			...
			t.active = 0, t.ajaxJSONP = function(e, i) {
				...
				if(a && a.promise(x), r.crossDomain || b("X-Requested-With", "XMLHttpRequest"), b("Accept", v || "*/*"), (v = r.mimeType || v) && (v.indexOf(",") > -1 && (v = v.split(",", 2)[0]), x.overrideMimeType && x.overrideMimeType(v)), (r.contentType || !1 !== r.contentType && r.data && "GET" != r.type.toUpperCase()) && b("Content-Type", r.contentType || "application/x-www-form-urlencoded"), r.headers)
		...
		}(gt), (_t = gt).fn.serializeArray = function() {
			var t, e = [];
			return _t([].slice.call(this.get(0).elements)).each((function() {
		...
		Lt = ht.extend({
			...
			floor: function(t) {
				for(var e = new Date(this.data.date_obj.getTime()), i = 0; i < wt.length; i++)
					if(wt[i][2](e), wt[i][0] == t) return new Lt(e);
	...
	function qt(t) {
		...
		let o = r[0];
		if(e.hour = parseInt(o), i && "p" == i.toLowerCase()[0] && 12 != e.hour ? e.hour += 12 : i && "a" == i.toLowerCase()[0] && 12 == e.hour && (e.hour = 0), isNaN(e.hour) || e.hour < 0 || e.hour > 23) throw new A("invalid_hour_err", o);
		if(r.length > 1) {
			let t = r[1];
		...
		if(r.length > 2) {
			var s = r[2].split(/[\.,]/);
			if((r = s.concat(r.slice(3))).length > 2) throw new A("invalid_second_fractional_err");
	...
	class Vt {
		...
		_assignID(t) {
			var e = t.unique_id;
			return F(e) || (e = t.text ? B(t.text.headline) : null), t.unique_id = function(t, e) {
		...
		_makeUniqueIdentifiers(t, e) {
			for(var i = [t], n = 0; n < e.length; n++) F(e[n].unique_id) && (e[n].unique_id = B(e[n].unique_id), -1 == i.indexOf(e[n].unique_id) ? i.push(e[n].unique_id) : e[n].unique_id = "");
			if(i.length != e.length + 1)
				for(n = 0; n < e.length; n++)
					if(!e[n].unique_id) {
						var r = e[n].text ? B(e[n].text.headline) : null;
	...
	async function ee(t, e) {
		...
		await Jt({
			...
			if("response_not_csv" == t.proxy_err_code) throw new A("Timeline could not read the data for your timeline. Make sure you have published it to the web.");
	...
	async function ie(t, e) {
		let i = null,
			n = {};
		if("function" == typeof e ? i = e : "object" == typeof e && (n = e, i = e.callback, "function" == typeof n.callback && (i = n.callback)), !i) throw new A("Second argument to makeConfig must be either a function or an object which includes a 'callback' property with a 'function' type value");
		var r, a;
		if(te(t)) {
			try {
	...
	ae("human", wt), ae("cosmological", At);
	class oe {
		constructor(t, e) {
			var i = t.events;
	...
	class ce {
		...
		_initLayout() {
			...
			if("" != this.data.text) {
				var e = "";
				e += (i = 1 == this.options.autolink ? V(this.data.text) : this.data.text).match(/<p>[\s\S]*?<\/p>/) ? i : "<p>" + i + "</p>", this._el.content = M("div", "tl-text-content", this._el.content_container), this._el.content.innerHTML = e
			}
			var i;
			this.onLoaded()
		}
	...
	class ue {
		...
		_initLayout() {
			this.message = new Rt(this._el.container, this.options, this.getLanguage()), this._el.content_container = M("div", "tl-media-content-container", this._el.container), this.data.link && "" != this.data.link ? (this._el.link = M("a", "tl-media-link", this._el.content_container), this._el.link.href = this.data.link, this.data.link_target && "" != this.data.link_target ? this._el.link.target = this.data.link_target : this._el.link.target = "_blank", "_blank" == this._el.link.target && this._el.link.setAttribute("rel", "noopener"), this._el.content = M("div", "tl-media-content", this._el.link)) : this._el.content = M("div", "tl-media-content", this._el.content_container)
		}
		_updateDisplay(t, e, i) {
	...
	class me extends ue {
		_loadMedia() {
			var t, e = this;
			this.youtube_loaded = !1, this._el.content_item = this.domCreate("div", "tl-media-item tl-media-youtube tl-media-shadow", this._el.content), this._el.content_item.id = W(7), t = function(t) {
				var e, i, n, r = [];
				...
				return r
			}(this.data.url), this.media_id = {}, this.data.url.match("v=") ? this.media_id.id = t.v : this.data.url.match("/embed/") ? this.media_id.id = this.data.url.split("embed/")[1].split(/[?&]/)[0] : this.data.url.match(/v\/|v=|youtu\.be\//) ? this.media_id.id = this.data.url.split(/v\/|v=|youtu\.be\//)[1].split(/[?&]/)[0] : z("YOUTUBE IN URL BUT NOT A VALID VIDEO"), this.data.url.match("start=") ? this.media_id.start = it(this.data.url.split("start=")[1]) : this.data.url.match("t=") && (this.media_id.start = it(this.data.url.split("t=")[1])), this.data.url.match("end=") && (this.media_id.end = it(this.data.url.split("end=")[1])), this.media_id.hd = Boolean(void 0 !== t.hd), fe("https://www.youtube.com/iframe_api", (function() {
				e.createMedia()
			}))
		}
		_updateMediaDisplay() {
			this._el.content_item.style.height = K({
	...
	class ye extends ue {
		_loadMedia() {
			var t, e = this;
			this._el.content_item = this.domCreate("div", "tl-media-item tl-media-wikipedia", this._el.content), this._el.content_container.className = "tl-media-content-container tl-media-content-container-text", this.media_id = this.data.url.split("wiki/")[1].split("#")[0].replace("_", " "), this.media_id = this.media_id.replace(" ", "%20"), t = "https://" + this.data.url.split("//")[1].split(".wikipedia")[0] + ".wikipedia.org/w/api.php?action=query&prop=extracts|pageimages&redirects=&titles=" + this.media_id + "&exintro=1&format=json&callback=?", yt({
				type: "GET",
				url: t,
				dataType: "json",
				success: function(t) {
	...
	class be extends ue {
		_loadMedia() {
			var t, e = this;
			this._el.content_item = this.domCreate("div", "tl-media-item tl-media-iframe tl-media-soundcloud tl-media-shadow", this._el.content), this.media_id = this.data.url, t = "https://soundcloud.com/oembed?url=" + this.media_id + "&format=js&callback=?", vt(t, (function(t) {
				fe("https://w.soundcloud.com/player/api.js", (function() {
					e.createMedia(t)
				}))
			}))
		}
	...
	class xe extends ue {
		...
		_updateMediaDisplay() {
			this._state.loaded && (this._el.content_item.style.height = K({
				w: this._el.content_item.offsetWidth
			}) + "px")
		}
		_stopMedia() {
	...
	class Te extends ue {
		_loadMedia() {
			...
			t = "https://api.twitter.com/1/statuses/oembed.json?id=" + this.media_id + "&omit_script=true&include_entities=true&callback=?", yt({
				type: "GET",
				url: t,
				dataType: "json",
				success: function(t) {
		...
		createMedia(t) {
			var e, i, n, r = "",
				...
				o = "",
				s = this;
			a = t.html.split("</p>&mdash;")[0] + "</p></blockquote>", e = t.author_url.split("twitter.com/")[1], i = (o = t.html.split("</p>&mdash;")[1].split('<a href="')[1]).split('">')[0], n = o.split('">')[1].split("</a>")[0], (a = a.replace(/<a href/gi, '<a target="_blank" rel="noopener" href')).includes("pic.twitter.com") ? (fe("https://platform.twitter.com/widgets.js", (function() {
	...
	class Le extends ue {
		_loadMedia() {
			var t, e = this;
			try {
				this.establishMediaID(), t = "https://api.flickr.com/services/rest/?method=flickr.photos.getSizes&api_key=" + this.options.api_key_flickr + "&photo_id=" + this.media_id + "&format=json&jsoncallback=?", vt(t, (function(t) {
		...
		_getMeta() {
			var t, e = this;
			t = "https://api.flickr.com/services/rest/?method=flickr.photos.getInfo&api_key=" + this.options.api_key_flickr + "&photo_id=" + this.media_id + "&format=json&jsoncallback=?", vt(t, (function(t) {
	...
	class Ee extends ue {
		_loadMedia() {
			var t = this;
			this._el.content_item = this.domCreate("div", "tl-media-item tl-media-documentcloud tl-media-shadow", this._el.content), this._el.content_item.id = W(7), this.data.url.match(/\.html$/) ? this.data.url = this._transformURL(this.data.url) : this.data.url.match(/.(json|js)$/) || z("DOCUMENT CLOUD IN URL BUT INVALID SUFFIX"), fe(["https://assets.documentcloud.org/viewer/loader.js", "https://assets.documentcloud.org/viewer/viewer.js"], (function() {
				t.createMedia()
			}))
		}
		_transformURL(t) {
	...
	class je extends ue {
		...
		getImageURL() {
			...
			bt(`${Se}${this.data.url}`).then(t => t.thumbnail_url).catch(t => {
	...
	class ze extends ue {
		_loadMedia() {
			try {
				...
				fe(["https://s.imgur.com/min/embed.js"], (function() {
					t.createMedia()
				}))
			} catch(t) {
		...
		createMedia() {
			...
			this._el.content_item = this.domCreate("div", "tl-media-item tl-media-image tl-media-imgur", this._el.content), yt({
				type: "GET",
				url: e,
				dataType: "json",
				success: function(e) {
		...
		_updateMediaDisplay() {
			this._el.content_item.style.width = this.options.width + "px", this._el.content_item.style.height = K({
				w: this.options.width
			}) + "px"
		}
	}
		...
		_initLayout() {
			if(this._el.container = M("div", "tl-timemarker"), this.data.unique_id && (this._el.container.id = this.data.unique_id + "-marker"), this.data.end_date && (this.has_end_date = !0, this._el.container.className = "tl-timemarker tl-timemarker-with-end"), this._el.timespan = M("div", "tl-timemarker-timespan", this._el.container), this._el.timespan_content = M("div", "tl-timemarker-timespan-content", this._el.timespan), this._el.content_container = M("div", "tl-timemarker-content-container", this._el.container), this._el.content = M("div", "tl-timemarker-content", this._el.content_container), this._el.line_left = M("div", "tl-timemarker-line-left", this._el.timespan), this._el.line_right = M("div", "tl-timemarker-line-right", this._el.timespan), this.data.media) {
				...
				var t = {
					...
					e = this.data.media.thumbnail ? Fe(t, !0) : null;
				if(e) {
					var i = new e.cls(t);
					...
					var n = Fe(this.data.media).type;
					this._el.media = M("span", "tl-icon-" + n, this._el.media_container)
				}
			}
			this._el.text = M("div", "tl-timemarker-text", this._el.content), this._text = M("h2", "tl-headline", this._el.text), this.data.text.headline && "" != this.data.text.headline ? this._text.innerHTML = G(this.data.text.headline) : this.data.text.text && "" != this.data.text.text ? this._text.innerHTML = G(this.data.text.text) : this.data.media && this.data.media.caption && "" != this.data.media.caption && (this._text.innerHTML = G(this.data.media.caption)), this.onLoaded()
		}
		_initEvents() {
	...
	class Be {
		...
		enable(t) {
			mt.addListener(this._el.drag, this.dragevent.down, this._onDragStart, this), mt.addListener(this._el.drag, this.dragevent.up, this._onDragEnd, this), this.data.pos.start = 0, this._el.move.style.left = this.data.pos.start.x + "px", this._el.move.style.top = this.data.pos.start.y + "px", this._el.move.style.position = "absolute"
		}
		disable() {
			mt.removeListener(this._el.drag, this.dragevent.down, this._onDragStart, this), mt.removeListener(this._el.drag, this.dragevent.up, this._onDragEnd, this)
		}
		...
		_onDragStart(t) {
			...
			}, this.data.time.start = (new Date).getTime(), this.fire("dragstart", this.data), mt.addListener(this._el.drag, this.dragevent.move, this._onDragMove, this), mt.addListener(this._el.drag, this.dragevent.leave, this._onDragEnd, this)
		}
		_onDragEnd(t) {
			this.data.sliding = !1, mt.removeListener(this._el.drag, this.dragevent.move, this._onDragMove, this), mt.removeListener(this._el.drag, this.dragevent.leave, this._onDragEnd, this), this.fire("dragend", this.data), this._momentum()
		}
		...
		_animateMomentum() {
			...
			this.options.enable.y && ((this.options.constraint.top || this.options.constraint.bottom) && (t.y > this.options.constraint.bottom ? t.y = this.options.constraint.bottom : t.y < this.options.constraint.top && (t.y = this.options.constraint.top)), e.top = Math.floor(t.y) + "px"), this.options.enable.x && (this.options.constraint.left && t.x >= this.options.constraint.left && (t.x = this.options.constraint.left), this.options.constraint.right && t.x < this.options.constraint.right && (t.x = this.options.constraint.right), e.left = Math.floor(t.x) + "px"), this.animator = ut(this._el.move, e), this.fire("momentum", this.data)
		}
	}
	$(Be, ct);
	class We {
		...
		_getTimeScale() {
			...
			return 0 == t && (z("marker_height_min option must not be zero."), t = 30), this.max_rows = Math.round((this.options.height - this._el.timeaxis_background.offsetHeight - this.options.marker_padding) / t), this.max_rows < 1 && (this.max_rows = 1), new oe(this.config, {
			...
			if(this.options.has_groups)
				for(var t = this.options.height - this._el.timeaxis_background.offsetHeight, e = Math.floor(t / this.timescale.getNumberOfRows() - this.options.marker_padding), i = (this.timescale.getGroupLabels(), 0), n = 0; i < this._groups.length; i++) {
					var r = Math.floor(n * (e + this.options.marker_padding)),
						a = !1;
					r > t - this.options.marker_padding && (a = !0), this._groups[i].setRowPosition(r, this._calculated_row_height + this.options.marker_padding / 2), this._groups[i].setAlternateRowColor(U(i), a), n += this._groups[i].data.rows
				}
		}
		_addMarker(t) {
		...
		_createEras(t) {
			for(var e = 0; e < t.length; e++) {
				var i = t[e],
					n = new le(i.start_date, i.end_date, i.headline, this.options);
	...
	class Ue {
		...
		show() {
			this.animator = ut(this._el.slider_container, {
		...
		_initLayout() {
			if(this._el.container = M("div", "tl-slide"), this.has.title && (this._el.container.className = "tl-slide tl-slide-titleslide"), this.data.unique_id && (this._el.container.id = this.data.unique_id), this._el.scroll_container = M("div", "tl-slide-scrollable-container", this._el.container), this._el.content_container = M("div", "tl-slide-content-container", this._el.scroll_container), this._el.content = M("div", "tl-slide-content", this._el.content_container), this._el.background = M("div", "tl-slide-background", this._el.container), this.data.background) {
				if(this.data.background.url) {
					var t = Fe(this.data.background, !0);
			...
			this.data.media && this.data.media.url && "" != this.data.media.url && (this.has.media = !0), this.data.text && this.data.text.text && (this.has.text = !0), this.data.text && this.data.text.headline && (this.has.headline = !0), this.has.media && (this.data.media.mediatype = Fe(this.data.media), this.options.media_name = this.data.media.mediatype.name, this.options.media_type = this.data.media.mediatype.type, this.options.autolink = this.data.autolink, this._media = new this.data.media.mediatype.cls(this.data.media, this.options, this.getLanguage())), (this.has.text || this.has.headline) && (this._text = new ce(this.data.text, {
	...
	class Ge {
		constructor(t, e, i, n) {
			n && this.setLanguage(n), this._el = {
				...
				dragging: !0,
				trackResize: !0
			}, "object" == typeof t ? (this._el.container = t, this.options.id = W(6, "tl")) : (this.options.id = t, this._el.container = T(t)), this._el.container.id || (this._el.container.id = this.options.id), this.animator = null, N(this.options, i), N(this.data, e)
		}
		init() {
		...
		_createSlide(t, e, i) {
			var n = new Ue(t, this.options, e, this.getLanguage());
		...
		goTo(t, e, i) {
			...
			t < this._slides.length && t >= 0 && (this.current_id = this._slides[t].data.unique_id, this.animator && this.animator.stop(), this._swipable && this._swipable.stopMomentum(), e ? (this._el.slider_container.style.left = -this.slide_spacing * t + "px", this._onSlideChange(i)) : this.animator = ut(this._el.slider_container, {
		...
		_initLayout() {
			S(this._el.container, "tl-storyslider"), this._el.slider_container_mask = M("div", "tl-slider-container-mask", this._el.container), this._el.background = M("div", "tl-slider-background tl-animate", this._el.container), this._el.slider_container = M("div", "tl-slider-container tlanimate", this._el.slider_container_mask), this._el.slider_item_container = M("div", "tl-slider-item-container", this._el.slider_container), this.options.width = this._el.container.offsetWidth, this.options.height = this._el.container.offsetHeight, this._nav.previous = new Ze({
				...
				direction: "next"
			}), this._nav.next.addTo(this._el.container), this._nav.previous.addTo(this._el.container), this._el.slider_container.style.left = "0px", x && (this._swipable = new Be(this._el.slider_container_mask, this._el.slider_container, {
				enable: {
					x: !0,
					y: !1
				},
		...
		_fireMouseEvent(t) {
			if(this._loaded) {
				var e = t.type;
				e = "mouseenter" === e ? "mouseover" : "mouseleave" === e ? "mouseout" : e, this.hasEventListeners(e) && ("contextmenu" === e && mt.preventDefault(t), this.fire(e, {
					latlng: "something",
	...
	class Ye {
		...
		_initEvents() {
			mt.addListener(this._el.button_backtostart, "click", this._onButtonBackToStart, this), mt.addListener(this._el.button_zoomin, "click", this._onButtonZoomIn, this), mt.addListener(this._el.button_zoomout, "click", this._onButtonZoomOut, this)
		}
		_updateDisplay(t, e, i) {
			t && (this.options.width = t), e && (this.options.height = e)
		}
	...
	class Je {
		constructor(t, e, i) {
			...
			var r, a;
			N(this.options, i), this.options.script_path || (this.options.script_path = this.determineScriptPath()), i.soundcite && this.on("ready", () => {
				z("Loading Soundcite resources "), pe("https://cdn.knightlab.com/libs/soundcite/latest/css/player.css"), fe("https://cdn.knightlab.com/libs/soundcite/latest/js/soundcite.min.js")
				...
				this.updateDisplay()
			}.bind(this)), this.options.debug && (a = console.log, O.push(a)), S(this._el.container, "tl-timeline"), this.options.is_embed && S(this._el.container, "tl-timeline-embed"), this.options.is_full_embed && S(this._el.container, "tl-timeline-full-embed"), this._loadLanguage(e)
		}
		_loadStyles() {
			let t = null,
				e = null;
			...
			if(t && pe(t), this.options.theme && (0 == this.options.theme.indexOf("http") || this.options.theme.match(/\.css$/))) e = this.options.theme;
		...
		_initLayout() {
			this.message.removeFrom(this._el.container), this._el.container.innerHTML = "", "top" == this.options.timenav_position ? (this._el.timenav = M("div", "tl-timenav", this._el.container), this._el.storyslider = M("div", "tl-storyslider", this._el.container)) : (this._el.storyslider = M("div", "tl-storyslider", this._el.container), this._el.timenav = M("div", "tl-timenav", this._el.container)), this._el.menubar = M("div", "tl-menubar", this._el.container), this.options.width = this._el.container.offsetWidth, this.options.height = this._el.container.offsetHeight, this.options.timenav_height = this._calculateTimeNavHeight(this.options.timenav_height), this._timenav = new We(this._el.timenav, this.config, this.options, this.language), this._timenav.on("loaded", this._onTimeNavLoaded, this), this._timenav.options.height = this.options.timenav_height, this._timenav.init(), this.options.initial_zoom && this.setZoom(this.options.initial_zoom), this._storyslider = new Ge(this._el.storyslider, this.config, this.options, this.language), this._storyslider.on("loaded", this._onStorySliderLoaded, this), this._storyslider.init(), this._menubar = new Ye(this._el.menubar, this._el.container, this.options), "portrait" == this.options.layout ? this.options.storyslider_height = this.options.height - this.options.timenav_height - 1 : this.options.storyslider_height = this.options.height - 1, this._updateDisplay(this._timenav.options.height, !0, 2e3)
		}
		_initEvents() {
		...
		_updateDisplay(t, e, i) {
			var n, r = this.options.duration,
				...
				o = 0;
			i && (r = i), this.options.width = this._el.container.offsetWidth, this.options.height = this._el.container.offsetHeight, this.options.width <= this.options.skinny_size ? (a += " tl-skinny", this.options.layout = "portrait") : this.options.width <= this.options.medium_size ? (a += " tl-medium", this.options.layout = "landscape") : this.options.layout = "landscape", x && (this.options.layout = (n = "portrait", window.innerWidth > window.innerHeight && (n = "landscape"), Math.abs(window.orientation), n)), c ? (a += " tl-mobile", this.options.timenav_height = this._calculateTimeNavHeight(t, this.options.timenav_mobile_height_percentage)) : this.options.timenav_height = this._calculateTimeNavHeight(t), "portrait" == this.options.layout ? a += " tl-layout-portrait" : a += " tl-layout-landscape", this.options.storyslider_height = this.options.height - this.options.timenav_height, o = "top" == this.options.timenav_position ? Math.ceil(this.options.timenav_height) / 2 - this._el.menubar.offsetHeight / 2 - 19.5 : Math.round(this.options.storyslider_height + 1 + Math.ceil(this.options.timenav_height) / 2 - this._el.menubar.offsetHeight / 2 - 17.5), e ? (this._el.timenav.style.height = Math.ceil(this.options.timenav_height) + "px", this.animator_storyslider && this.animator_storyslider.stop(), this.animator_storyslider = ut(this._el.storyslider, {
				height: this.options.storyslider_height + "px",
				duration: r / 2,
				easing: st
			}), this.animator_menubar && this.animator_menubar.stop(), this.animator_menubar = ut(this._el.menubar, {
				top: o + "px",
				duration: r / 2,
				easing: st
